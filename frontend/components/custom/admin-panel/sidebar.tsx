...
export function Sidebar({ userDetails,freshCount, stockCount }: any) {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-full flex-col overflow-y-auto px-3 py-4 shadow-md dark:shadow-zinc-800">
        ...
        <Menu isOpen={sidebar?.isOpen} userDetails={userDetails} freshCount={freshCount} stockCount={stockCount}  />
      </div>
    </aside>
  );
}
